...
| --analyze                 	     | hap、apk、ios                          						| 通过rom size工具对打出的包进行包体积解析；[rom size工具使用方法](https://gitee.com/arkui-x2/docs/blob/master/zh-cn/application-dev/quick-start/start-with-rom-size.md)。             |
