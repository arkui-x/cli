...
function parseConfig() {
  const configCmd = program.command('config', { hidden: true })
    .usage('[arguments]')
    .option('--android-sdk', 'Android Sdk path.')
    .option('--android-studio-path', 'Android Studio path.')
    .option('--arkui-x-sdk', 'ArkUI-X Sdk path.')
    .option('--build-dir', 'Build Dir path.')
    .option('--deveco-studio-path', 'DevEco Studio path.')
    .option('--harmonyos-sdk', 'HarmonyOS Sdk path.')
    .option('--java-sdk', 'Java Sdk path.')
    .option('--nodejs-dir', 'Nodejs Dir path.')
    .option('--ohpm-dir', 'Ohpm path.')
    .option('--openharmony-sdk', 'OpenHarmony Sdk path.')
