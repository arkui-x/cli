...
function getSdkVersionMap() {
  const sdkVersionMap = new Map([
    ...
    ['24', new Map([['devEcoVersion', '6.1.1'], ['compileSdkVersion', '6.1.1(24)'], ['compatibleSdkVersion', '6.1.1(24)'], ['modelVersion', '6.1.1'], ['runtimeOS', 'HarmonyOS'], ['hvigor-ohos-arkui-x-plugin', '4.24.2']])],
    ['26.0.0', new Map([['devEcoVersion', '26.0.0'], ['compileSdkVersion', '26.0.0'], ['compatibleSdkVersion', '26.0.0'], ['modelVersion', '26.0.0'], ['runtimeOS', 'HarmonyOS'], ['hvigor-ohos-arkui-x-plugin', '4.24.2']])],
  ]);
